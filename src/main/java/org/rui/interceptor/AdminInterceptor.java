...
import static org.rui.constant.Constant.SESSION_ADMIN_USER;
...
//        System.out.println(request.getSession().getMaxInactiveInterval());
        User user = (User) request.getSession().getAttribute(SESSION_ADMIN_USER);
        if(null == user){
